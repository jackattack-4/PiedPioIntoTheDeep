...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 2420.083777535375; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -2263.461653906746; // x position of the perpendicular encoder (in tick units)
    }
