...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 2448.11143544887; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -2210.262815104362; // x position of the perpendicular encoder (in tick units)
    }
